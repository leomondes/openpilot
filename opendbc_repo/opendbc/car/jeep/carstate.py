...
class CarState(CarStateBase):
  ...
  def update(self, can_parsers) -> structs.CarState:
    ...
    ret.cruiseState.enabled = (cp_body.vl["ACC_2"]["ACC_ACTIVE"] in (6, 7, 8) or pt_cp.vl["ABS_6"]["ACC_BRAKE"] == 1) and pt_cp.vl["ENGINE_3"]["GEAR"] > 1 
    # add check gear because when turn off car for a brief moment ACC_ACTIVE = 7
